  ...
  const categories = [
    {
      ...
      tags: [
        ["💀", "Death: grief & trauma"],
        ["🔥", "Ka-ra-te: all violence"],
        ["🌶️", "Smutty: explicit erotica"],
        ["👙", "Sexy times: mild to moderate sexual content"],
    ...
    {
      label: "👁️ Whose story is this?",
      subtitle: "Who is centered in the book",
      headerColor: "#2A3A6A",
      bg: "#EAF0FA",
      border: "#A0B0E0",
      tags: [
        ...
        ["🧑‍🔬", "Scientist"],
        ["👨", "Men being men"],
        ["♿", "Bodily autonomy can be yours too"],
        ["🌀", "Mental struggles"],
      ],
    },
    {
